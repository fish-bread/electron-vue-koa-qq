...
const { createUser, searchUser, searchUserUid,searchUserFriendUid, searchUserAddUid, changeUser, deleteUser, changeUserHeadshot, searchUserBackground} = require('../service/user.service.js')
    ...
    if (user === '') {
        ...
        ctx.body = {
            user: {
                ...
                search_user_headshot: `http://localhost:3000${user.user_headshot}?_t=${Date.now()}`
            }
        }
    }
})
